    ...
    return (
        <div className="w-full">
            ...
            <div className="relative">
                <select
                    className="block appearance-none w-full bg-gray-200 dark:bg-gray-500 text-gray-700 dark:text-white py-2 px-2 md:px-3 md:py-2 dark:focus:bg-gray-500 rounded leading-tight focus:outline-none focus:shadow-outline focus:bg-white focus:border-gray-500 "
                    id={name}
                    name={name}
                    value={value}
                    onChange={onChange}
