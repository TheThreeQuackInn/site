...
export default function Hero() {
    return (
        <div className={'flex items-center py-10 mx-auto hero'}>
            <div className="sm:text-center lg:text-left container mx-auto">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start items-center">
                    <div>
                        <a
                            href="/conjure-animals"
                            className="button-gradient w-full flex items-center justify-center px-6 py-3 text-base leading-6 font-medium rounded-md text-white focus:outline-black dark:focus:outline-white md:py-4 md:text-lg md:px-10"
                        >
                            Take me to the tool
                        </a>
                    </div>
                    <div className="rounded-md sm:ml-8 mt-4 sm:mt-0">
                        <a
                            href="https://www.deviantart.com/huussii/art/Exiled-Druids-of-Lornwood-622851414"
                            target="_blank"
